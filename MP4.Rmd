...
```{r This document was rendered at `r format(Sys.time(), "%B %e, %Y at %H:%M:%S"))`}
...
![*Citibike station in Central Park*](https://s3.amazonaws.com/bklyner/bklyner/wp-content/uploads/2015/07/fgf_citibike_park.jpg){width=350}
...
hours3374_2006 <- ggplot(data = central_park_north_south, aes(x = initial_time, y = num_trips)) +
  geom_line(aes(color = gender)) + 
  geom_point(aes(color = gender))
hours3374_2006
```
